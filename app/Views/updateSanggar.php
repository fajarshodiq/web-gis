...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Peta Sebaran Sanggar Tari</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Create Sanggar</h6>
                </div>
                <div class="card-body">
                    <form action="/form/prosesupdate/<?= $data['slug']; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= ($validation->hasError('nama_sanggar')) ? 'is-invalid' : ''; ?>" name="nama_sanggar" value="<?= $data['nama_sanggar']; ?>" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= ($validation->hasError('nama_pimpinan')) ? 'is-invalid' : ''; ?>" name="nama_pimpinan" value="<?= $data['nama_pimpinan']; ?>">
                            <div class="invalid-feedback">
...
<script>
    function img() {
        ...
        gambarLabel.textContent = foto_sanggar.files[0].name;
    }
</script>
<?= $this->endSection(); ?>